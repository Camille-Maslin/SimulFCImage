...
class TestBeeSimulating(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        color_balance = self.bee_sim._BeeSimulating__color_balance
        self.assertEqual(color_balance['UV'], 1.0)
        self.assertEqual(color_balance['Blue'], 1.0)
        self.assertEqual(color_balance['Green'], 1.0)
    ...
    def test_calculate_photoreceptor_sensitivity(self):
        ...
        UV, Blue, Green = self.bee_sim._BeeSimulating__calculate_photoreceptor_sensitivity(344)
        ...
        UV, Blue, Green = self.bee_sim._BeeSimulating__calculate_photoreceptor_sensitivity(436)
        ...
        UV, Blue, Green = self.bee_sim._BeeSimulating__calculate_photoreceptor_sensitivity(544)
        self.assertGreater(Green, UV)  # Green sensitivity should be highest
        self.assertGreater(Green, Blue)
        
        # Test normalization - sum should equal 1
        UV, Blue, Green = self.bee_sim._BeeSimulating__calculate_photoreceptor_sensitivity(400)
    ...
    def test_simulate(self):
        ...
        for band in self.mock_image_ms.get_bands():
            band.get_wavelength.assert_called()
            band.get_shade_of_grey.assert_called()
    ...
    def test_wavelength_extremes(self):
        ...
        band_extreme1.get_wavelength.return_value = (300, 300)  # Deep UV
        band_extreme1.get_shade_of_grey.return_value = np.ones((10, 10)) * 0.5
        
        band_extreme2 = MagicMock()
        band_extreme2.get_wavelength.return_value = (650, 650)  # Deep Red
        band_extreme2.get_shade_of_grey.return_value = np.ones((10, 10)) * 0.5
