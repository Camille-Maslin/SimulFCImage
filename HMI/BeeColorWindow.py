...
class BeeColorWindow(tk.Toplevel):
    def __init__(self, parent, image_path):  # Accept image_path as a parameter
        super().__init__(parent)
        self.image_path = image_path  # Store the image_path
        self.title("Bee Color Simulation")
        self.geometry("800x600")

        # Widgets
        ttk.Label(self, text="Bee Color Simulation", font=("Arial", 20)).pack(pady=20)
        self.image_label = tk.Label(self, text="Display Bee Color Image Here", font=("Arial", 16))
